...
export class OrdersController {
  ...
  @Get(':id') async findOne(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string) { return { success: true, data: await this.ordersService.findOne(id, user.id, user.role === 'ADMIN') }; }
