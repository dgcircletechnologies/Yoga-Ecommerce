...
const labels = [["Total Orders", null], ["New Orders", "New"], ["Processing", "Processing"], ["Shipped", "Shipped"], ["Delivered", "Delivered"], ["Cancelled", "Cancelled"], ["Refunded", "Refunded"]] as const;
