...
export function PageHero({ title }: PageHeroProps) {
  return (
    <section className="flex min-h-[400px] items-center bg-brand-purple bg-cover bg-center bg-no-repeat px-0 pb-12 pt-28 text-center text-white" style={{ backgroundImage: "linear-gradient(rgba(155, 89, 182, 0.6), rgba(155, 89, 182, 0)), url('/lotuslab/bg-header.png')" }}>
      <Container>
