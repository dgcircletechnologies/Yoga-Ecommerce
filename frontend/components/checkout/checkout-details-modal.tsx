...
export type PurchaseSummary = { kind: "Product" | "Service"; name: string; price: string; quantity?: number; sessions?: string };
type Props = { initialValues: CheckoutDetails; onClose: () => void; onContinue: (values: CheckoutDetails) => void; onMemberContinue: () => void; title?: string; description?: string; submitLabel?: string; summary?: PurchaseSummary };
...
export function CheckoutDetailsModal({ initialValues, onClose, onContinue, onMemberContinue, title = "Where should we send it?", description = "Share your details to review your order and continue securely.", submitLabel = "Review order", summary }: Props) {
