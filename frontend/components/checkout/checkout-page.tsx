...
import { CheckoutDetailsModal } from "./checkout-details-modal";
...
export function CheckoutPage() {
  ...
  async function pay() {
    ...
    const payment = await beginPayment({ amount: cartSubtotal, currency: "USD", customerEmail: details.email });
